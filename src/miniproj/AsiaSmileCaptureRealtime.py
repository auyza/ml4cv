...
model = tf.keras.models.load_model('src/miniproj/model_save/MobileNetV2-AsiaSmile.hdf5') 

def detect_face_smile(capture_face, class_names, target_size=(224, 224)):
    frame = cv2.resize(capture_face, target_size)
            ...
            for detection in results.detections:
                ...
                if width > 0 and height > 0:
                    ...
                    if current_time - last_capture_time >= capture_interval:
                        ...
                        cv2.putText(cropped_face, last_detact_result,(10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
